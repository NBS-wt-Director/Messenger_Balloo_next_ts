-- AlterTable
ALTER TABLE "Message" ADD COLUMN "forwardFromChatId" TEXT;
...
INSERT INTO "new_User" ("adminRoles", "adminSince", "avatar", "birthDate", "createdAt", "displayName", "email", "fullName", "id", "isAdmin", "isOnline", "isSuperAdmin", "lastSeen", "passwordHash", "publicKey", "status", "updatedAt") SELECT "adminRoles", "adminSince", "avatar", "birthDate", "createdAt", "displayName", "email", "fullName", "id", "isAdmin", "isOnline", "isSuperAdmin", "lastSeen", "passwordHash", "publicKey", "status", "updatedAt" FROM "User";
DROP TABLE "User";
