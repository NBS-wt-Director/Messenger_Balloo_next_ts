    ...
    <div className="min-h-screen flex flex-col" style={{ background: 'var(--background)' }}>
      ...
      <main className="flex-1 px-4 py-16 flex items-center justify-center">
        <div className="text-center max-w-md">
          ...
          >
            <Lock size={48} style={{ color: 'var(--muted-foreground)' }} />
          </div>
          ...
          >
            {translations.accessDenied || 'Доступ запрещён'}
          </h2>
          ...
          >
            {translations.accessDeniedDesc || 'У вас нет доступа к этой странице. Возможно, вам необходима авторизация или специальные права.'}
          </p>
