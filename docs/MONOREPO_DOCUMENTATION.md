# 🎈 Balloo Messenger - Monorepo Documentation

**Полная документация монорепозитория App Balloo**
...
6. [Запуск в разработке](#запуск-в-разработке)
7. [Сборка для продакшена](#сборка-для-продакшена)
...
**Balloo Messenger** — это современный мессенджер с сквозным шифрованием (E2E), аудио/видео звонками и интеграцией с облачным хранилищем.
...
|--------------|----------|
| **Единый источник истины** | Все компоненты в одном месте |
| **Упрощённая синхронизация** | Общие типы и утилиты легко использовать |
| **Упрощённый деплой** | Один репозиторий для всех компонентов |
| **Легче рефакторинг** | Изменения в общих библиотеках сразу доступны всем |
| **Согласованность версий** | Все компоненты используют одинаковые зависимости |
