...
### work_server Docker Network

```
┌──────────────────────────────────────────┐
│          work_server Internal            │
...
home_aio
    ↓ git pull / rsync
work_server (repositories mirror)
```
...
work_server → execution-plane, production, critical
home_aio → execution-plane, dev
home_nas → storage-plane, backup
